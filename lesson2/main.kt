...
fun putIntoSlot(
    ...
    // если слот не пуст - стакаем в него предметы, только если, это тот же предмет и не максимум предметов в этом стаке
    ...
    // если предмет другой (или максимальное число стака = 1) - не кладём данный предмет
    // На данной реализации просто пока что будет надпись "не получилось"
    return newSlots
}
        ...
        addPanelSurface {
            ...
            Column {
                ...
                Row{
                    ...
                    //Выводим обновляемый хотбар на интерфейсе
                    ...
                    for(i in 0 until 9){
                        ...
                        Box{
                            ...
                            val stack = slots[i]
                            // значение слота = имя предметов + количество предметов в слоте
                            if (stack == null){
                                Text(""){}
                            } else{
                                Column{
